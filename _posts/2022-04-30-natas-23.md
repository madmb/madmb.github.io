...
Para que se cumpla la condición $_REQUEST['passwd'] > 10:

En php tiene una particularidad cuando se compara numeros que contienen letras. Por ejemplo:
...
Para que se cumpla en este escenario tiene que comenzar con un número sino dara falso.

Ya solo falta la primera parte:
